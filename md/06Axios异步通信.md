# 【狂神说Java】Vue学习笔记05-----Axios异步通信

[参考链接](https://blog.csdn.net/pan_h1995/article/details/106792712)
...
<script type="text/javascript">
    var vm = new Vue({
        el:"#vue",
        //data：属性：vm
        //这个data是方法,return是返回到当前对象的data属性
        data(){
            return{
                info:{
                    name:null,
...
![1604764658792](06Axios异步通信.assets/1604764658792.png)
...
![在这里插入图片描述](06Axios异步通信.assets/20200616222020393.png)